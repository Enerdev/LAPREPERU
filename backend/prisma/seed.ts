...
async function main() {
  ...
  const s3 = await prisma.student.create({
    data: { dni: "89456123", nombres: "Lucía Fernanda", apellidos: "Vargas Castro", email: "lucia.vargas@email.com", telefono: "965432109", sede: "Puno", ciclo: "I Ciclo", estado: "pendiente", fechaMatricula: new Date("2026-03-15"), pagado: false, monto: 380, montoPagado: 0 },
  });
  ...
  await prisma.payment.createMany({
    data: [
      { studentId: s1.id, concepto: "Mensualidad Marzo 2026", monto: 450, fecha: new Date("2026-03-10"), estado: "pagado", sede: "Puno", metodoPago: "Transferencia" },
      ...
      { studentId: s3.id, concepto: "Mensualidad Marzo 2026", monto: 380, fecha: new Date("2026-03-15"), estado: "pendiente", sede: "Puno", metodoPago: "-" },
      { studentId: s4.id, concepto: "Mensualidad Febrero 2026", monto: 420, fecha: new Date("2026-02-28"), estado: "pagado", sede: "Juliaca", metodoPago: "Yape" },
